...
\textbf{Atualização de cotações através da consulta de \textit{Web Services} em tempo real}
...
\vspace{1.5cm}\rule{0.95\linewidth}{1pt}
\parbox{0.9\linewidth}{%
Prof. Gleydson Lima \dotfill\ FARN}

\vspace{1.5cm}\rule{0.95\linewidth}{1pt}
\parbox{0.9\linewidth}{%
Prof. Davi do Vale \dotfill\ FARN}
...
\item Ao meu orientador, professor Ricardo Wendell, sou grato pela orientação.
...
\item À minha noiva Rosana Curvelo de Souza pelo constante incentivo.
